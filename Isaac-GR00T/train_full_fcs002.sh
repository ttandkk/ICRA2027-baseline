...
#SBATCH --job-name=gr00t_fcs002_ft_full
#SBATCH --output=/projects/haitian003ssd/ICRA2027-baseline/Isaac-GR00T/logs/gr00t_fcs002_ft_full_%j.log
#SBATCH --error=/projects/haitian003ssd/ICRA2027-baseline/Isaac-GR00T/logs/gr00t_fcs002_ft_full_%j.err
...
# FCS002 matches the FC003 Panda schema: 10-D state/action and three cameras.
MODEL_PATH="${MODEL_PATH:-${GROOT_DIR}/pretrained/GR00T-N1.7-3B}"
DATASET_PATH="${DATASET_PATH:-/projects/haitian003ssd/Dataset/fcs_002_two_static_objects_to_container_slots}"
MODALITY_CONFIG="${MODALITY_CONFIG:-${GROOT_DIR}/examples/fc003_panda_config.py}"
EMBODIMENT_TAG="${EMBODIMENT_TAG:-NEW_EMBODIMENT}"
RUN_NAME="${RUN_NAME:-fcs002_two_static_objects_finetune_full_${JOB_ID}}"
...
# Fine-tune projector + diffusion/action head; freeze LLM and vision backbone.
TUNE_LLM="${TUNE_LLM:-0}"
...
# W&B credentials are inherited from the submission environment.
...
echo "FCS002 full finetune finished."
