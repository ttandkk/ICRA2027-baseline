...
class FinetuneConfig:
    ...
    """Video decoding backend used by the LeRobot dataset loader."""
    ...
    """Optimizer name passed through to HuggingFace TrainingArguments.optim."""
    ...
    tf32: bool = True
    """If True, enable TF32 matmul kernels where supported."""

    fp16: bool = False
    """If True, run trainer compute in FP16 precision."""

    bf16: bool = True
    """If True, run trainer compute in BF16 precision."""
