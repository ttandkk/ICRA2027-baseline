...
DATASET_PATH="${DATASET_PATH:-${LEROBOT_CM_ROOT}/cm_000_hang_mug_on_rotating_mug_tree:${LEROBOT_CM_ROOT}/cm_001_pick_object_from_rotating_platform:${LEROBOT_CM_ROOT}/cm_002_pick_static_object_to_rotating_container:${LEROBOT_CM_ROOT}/cm_003_pick_rotating_object_to_rotating_container:${LEROBOT_CM_ROOT}/cm_004_insert_test_tube_into_rotating_rack:${LEROBOT_CM_ROOT}/cm_005_long_horizon_hang_mugs_on_rotating_mug_tree:${LEROBOT_CM_ROOT}/cm_007_long_horizon_pick_static_objects_to_rotating_container:${LEROBOT_CM_ROOT}/cm_008_long_horizon_pick_rotating_objects_to_rotating_container:${LEROBOT_CM_ROOT}/cm_009_long_horizon_insert_test_tubes_into_rotating_rack:${LEROBOT_CM_ROOT}/cm_010_long_horizon_press_rotating_buttons_in_sequence}"
