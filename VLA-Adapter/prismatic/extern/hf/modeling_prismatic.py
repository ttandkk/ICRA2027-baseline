...
class PrismaticForConditionalGeneration(PrismaticPreTrainedModel):
    ...
    def forward(
        ...
        # === Handle Multimodal Forward ===
            ...
            # L1 action regression consumes hidden states only.  Calling the CausalLM
            # wrapper would materialize an unused full-vocabulary logits tensor.
            if skip_lm_head:
                language_model_output = self.language_model.model(
                    input_ids=None,
