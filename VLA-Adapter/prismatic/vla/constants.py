...
def detect_robot_platform():
    ...
    if "factory_conveyor" in cmd_args:
        return "FACTORY_CONVEYOR"
...
elif ROBOT_PLATFORM == "FACTORY_CONVEYOR":
    constants = FACTORY_CONVEYOR_CONSTANTS
